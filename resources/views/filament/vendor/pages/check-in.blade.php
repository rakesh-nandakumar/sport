<x-filament-panels::page>
    @if(! $booking)
        <div class="grid gap-6 md:grid-cols-2">
            <x-filament::section icon="heroicon-o-camera" heading="Camera scanner">
                <div
                    x-data="{
                        started: false,
                        error: false,
            ...
            <x-filament::section icon="heroicon-o-pencil" heading="Manual entry">
                ...
                <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">Type the booking reference, or the code from the QR.</p>
            </x-filament::section>
        </div>
    @else
        <div class="grid gap-6 md:grid-cols-2">
