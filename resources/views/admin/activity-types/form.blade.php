...
<form method="POST" action="{{ $type->exists ? route('admin.activity-types.update', $type) : route('admin.activity-types.store') }}" class="card shadow-sm border-0" style="max-width:760px">
