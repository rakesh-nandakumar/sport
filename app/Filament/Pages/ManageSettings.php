...
class ManageSettings extends Page
{
    ...
    public function mount(): void
    {
        $this->form->fill([
            ...
            'pay_at_venue_cancellation_limit' => (int) setting('payments.pay_at_venue_cancellation_limit'),
            ...
            ->components([
                Section::make('Payments')
                    ...
                    ->schema([
                        ...
                        TextInput::make('pay_at_venue_cancellation_limit')
                            ->label('Pay at Venue cancellation / no-show limit')
                            ->numeric()
                            ->minValue(3)
                            ->maxValue(4)
                            ->required()
                            ->helperText('At this many customer cancellations or no-shows, Pay at Venue is restricted until a Super Administrator restores it.'),
                    ]),
    ...
    public function save(): void
    {
        ...
        Settings::set('payments.pay_at_venue_cancellation_limit', (int) $data['pay_at_venue_cancellation_limit']);
